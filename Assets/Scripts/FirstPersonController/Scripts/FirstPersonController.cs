...
namespace StarterAssets
{
	...
	public class FirstPersonController : MonoBehaviour
	{
		...
		private bool _isTwerking;
		private bool _isHipHop;
		...
		private void Dance()
		{
			if (_hasAnimator)
			{
                if (Input.GetKeyDown(KeyCode.F1) && (_input.move == Vector2.zero && _input.jump == false))
                {
					_isHipHop = false;
                ...
                if (Input.GetKeyDown(KeyCode.F2) && (_input.move == Vector2.zero && _input.jump == false))
                {
                    _isTwerking = false;
                ...
                if ((_isTwerking == true || _isHipHop == true) && (_input.jump == true || _input.move != Vector2.zero))
                {
                    _animator.SetBool(_animIDTwerking, false);
					_animator.SetBool(_animIDHipHop, false);
                    _isTwerking = false;
